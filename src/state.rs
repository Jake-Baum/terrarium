...
impl State {
    ...
    pub fn update(&mut self) {
        ...
        self.camera_controller
            .update_camera(&mut self.camera, self.dt);
        self.camera_uniform
        ...
        self.light_uniform.position = (Quaternion::from_axis_angle(
            (0.0, 1.0, 0.0).into(),
            cgmath::Deg(60.0 * self.dt.as_secs_f32()),
        ) * old_position)
            .into();
        self.queue.write_buffer(
            &self.light_buffer,
